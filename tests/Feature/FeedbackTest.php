...
// test(
//     'Testing route to the feedback page', function () {
...
// test(
//     'Testing feedback adding', function () {
//         $user = User::factory()->create();
...
// test(
//     'Testing valid feedback searching', function () {
//         $user = User::factory()->create();
//         $response = sendTestFeedback($user, $this);
//         if ($response->status() == 302) {
...
// test(
//     'Testing non-valid feedback searching', function () {
//         $user = User::factory()->create();
//         $response = sendTestFeedback($user, $this);
//         if ($response->status() == 302) {
