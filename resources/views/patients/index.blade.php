<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8 w-full">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                <form method="GET" action="{{ route('patients.index') }}" class="space-y-4">
                    ...
                    <button
                        type="submit"
                        class="w-full px-6 py-2 bg-gray-500 text-white rounded shadow-md hover:bg-gray-600 transition"
                    >
                        Search Patients
                    </button>
                </form>
        ...
        @if(!empty($searchPerformed) && $searchPerformed)
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mt-6">
                @if(count($patients) > 0)
                    <div class="overflow-x-auto bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                        <x-table :headers="[
                            ['text' => 'Name'],
                            ['text' => 'Date of Birth'],
                            ['text' => 'Policy Number'],
                ...
                @else
                    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg border border-gray-200 dark:border-gray-700 p-6 text-center">
